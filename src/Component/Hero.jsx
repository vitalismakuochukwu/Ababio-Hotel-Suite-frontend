...
const Hero = () => {
  return (
    <div className='relative h-[100vh] w-full'>
      ...
      <div className='absolute inset-0 bg-green-900 opacity-60 z-10'>
        <div className='relative z-20 flex flex-col items-center justify-center h-full text-center text-white px-4'>
          <h2 className='text-lg bg-white-800  tracking-widest uppercase mb-4'>Where Luxury Meets Dinner</h2>
          <h1 className='text-4xl bg-white-800 font-bold mb-6'>ABABIO HOTEL & SUITE</h1>
